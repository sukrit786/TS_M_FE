...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--prefix' '/tmp/ruby' '--disable-install-doc' '--without-ext=tk,sdbm,gdbm,dbm,dl,coverage' 'CFLAGS=-g -O2  -I/hbb_shlib/include ' 'LDFLAGS=-L/hbb_shlib/lib -static-libstdc++ -L/hbb_shlib/lib64' 'CPPFLAGS=-I/hbb_shlib/include' 'CXXFLAGS=-g -O2  -I/hbb_shlib/include '"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/hbb_shlib/lib -static-libstdc++ -L/hbb_shlib/lib64 -Wl,--compress-debug-sections=zlib"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["LDFLAGS"] = "-L. -L/hbb_shlib/lib -static-libstdc++ -L/hbb_shlib/lib64 -fstack-protector-strong -rdynamic -Wl,-export-dynamic"
