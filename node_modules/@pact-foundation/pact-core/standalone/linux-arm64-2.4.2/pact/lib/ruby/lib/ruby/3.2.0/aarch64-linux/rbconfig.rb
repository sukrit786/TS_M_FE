...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.2.0/aarch64-linux")
  ...
  CONFIG["configure_args"] = " '--prefix' '/tmp/ruby' '--disable-install-doc' '--without-ext=tk,sdbm,gdbm,dbm,dl,coverage' 'CFLAGS=-g -O2  -I/hbb_shlib/include ' 'LDFLAGS=-L/hbb_shlib/lib -static-libstdc++' 'CPPFLAGS=-I/hbb_shlib/include' 'CXXFLAGS=-g -O2  -I/hbb_shlib/include '"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-L/hbb_shlib/lib -static-libstdc++ -Wl,--compress-debug-sections=zlib"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["ARFLAGS"] = "rcD "
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc (GCC) 9.3.1 20200408 (Red Hat 9.3.1-2)\nCopyright (C) 2019 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  CONFIG["CC_VERSION"] = "$(CC) --version"
  CONFIG["MJIT_CC"] = "/opt/rh/devtoolset-9/root/usr/bin/gcc"
  CONFIG["CSRCFLAG"] = ""
  CONFIG["COUTFLAG"] = "-o "
  CONFIG["OUTFLAG"] = "-o "
  ...
  CONFIG["GCC"] = "yes"
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-g -O2  -I/hbb_shlib/include "
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/hbb_shlib/include $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/hbb_shlib/lib -static-libstdc++ -fstack-protector-strong -rdynamic -Wl,-export-dynamic"
  CONFIG["CFLAGS"] = "-g -O2  -I/hbb_shlib/include "
