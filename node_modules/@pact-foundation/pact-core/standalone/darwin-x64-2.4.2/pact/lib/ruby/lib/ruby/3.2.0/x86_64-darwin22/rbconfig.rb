...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.2.0/x86_64-darwin22")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/tmp/ruby-3.2.3-x86_64/inst")
  ...
  CONFIG["configure_args"] = " '--prefix' '/tmp/ruby-3.2.3-x86_64/inst' '--without-ext=tk,sdbm,gdbm,dbm,dl,coverage' '--disable-install-doc' '--with-openssl-dir=/private/var/folders/2f/3sd99gzd12g01qxs44n328qc0000gn/T/cirrus-ci-build/osx/runtime' '--build=x86_64-apple-darwin22' 'build_alias=x86_64-apple-darwin22' 'CC=/private/var/folders/2f/3sd99gzd12g01qxs44n328qc0000gn/T/cirrus-ci-build/osx/internal/bin/cc' 'CXX=/private/var/folders/2f/3sd99gzd12g01qxs44n328qc0000gn/T/cirrus-ci-build/osx/internal/bin/c++'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/tmp/ruby-3.2.3-x86_64/inst"
  ...
  CONFIG["MJIT_CC"] = "/private/var/folders/2f/3sd99gzd12g01qxs44n328qc0000gn/T/cirrus-ci-build/osx/internal/bin/cc"
  CONFIG["CSRCFLAG"] = ""
  CONFIG["COUTFLAG"] = "-o "
  CONFIG["OUTFLAG"] = "-o "
  ...
  CONFIG["OBJCOPY"] = ":"
  CONFIG["NM"] = "/Library/Developer/CommandLineTools/usr/bin/nm"
  CONFIG["LD"] = "/Library/Developer/CommandLineTools/usr/bin/ld"
  CONFIG["CXX"] = "/private/var/folders/2f/3sd99gzd12g01qxs44n328qc0000gn/T/cirrus-ci-build/osx/internal/bin/c++"
  CONFIG["AS"] = "as"
  CONFIG["AR"] = "/Library/Developer/CommandLineTools/usr/bin/ar"
  CONFIG["CC"] = "/private/var/folders/2f/3sd99gzd12g01qxs44n328qc0000gn/T/cirrus-ci-build/osx/internal/bin/cc"
  CONFIG["wasmoptflags"] = ""
  CONFIG["WASMOPT"] = ""
